 ...
 * AAAA-record.
 *
 * @property    string  $ip_address  Target IPv6 address.
 * @property    string  $hostname    FQDN or subdomain.
 */
class A6Record extends DnsZoneRecord
{
     ...
     * @param   string       $ip_address Target IPv6 address.
